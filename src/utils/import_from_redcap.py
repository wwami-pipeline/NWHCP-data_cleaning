...
RED_CAP_TOKEN = os.getenv("RED_CAP_API_TOKEN", "2E036BFA999B6FB594112D27F524EA92")
GOOGLE_MAP_TOKEN = os.getenv("GOOGLE_MAP_API_TOKEN", "AIzaSyDp-LsNg9RusqlMLx2K9_VXXWudUk2-d6c")
